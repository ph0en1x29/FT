...
export const JOB_SELECT = {
  ...
  BOARD: `
    ...
    job_type,
    customer_id,
    customer:customers(customer_id, name, address, phone, contact_person, account_number),
    forklift_id,
    forklift:forklifts!forklift_id(serial_number, forklift_no, customer_forklift_no, make, model, type, site, location),
    assigned_technician_id,
    assigned_technician_name,
  ...
  DETAIL_FAST: `
    *,
    ...
    forklift:forklifts!forklift_id(*),
    parts_used:job_parts(*),
    media:job_media!job_media_job_id_fkey(media_id, type, category, created_at, description, url),
    extra_charges:extra_charges(*)
  `,
