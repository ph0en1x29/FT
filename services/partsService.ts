...
const PARTS_LIST_SELECT = 'part_id, part_name, part_code, category, sell_price, stock_quantity, is_liquid, base_unit, container_unit, container_size, container_quantity, bulk_quantity';
