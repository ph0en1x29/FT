...
// ── TransferJobModal ────────────────────────────────────────────
// KPI Engine Phase 2 (KPI_SPEC.md §3.2): admin-initiated reassignment that
// CLONES the job to a new -B/-C suffix (vs ReassignModal which swaps the
// tech in-place on the same row). The outgoing tech's KPI award is set to
// 0 pts by default; admin can approve a 5-pt partial credit via the toggle.
//
