...
type TabType = 'parts' | 'vanstock' | 'confirmations';
...
const InventoryPage: React.FC<InventoryPageProps> = ({ currentUser }) => {
  ...
  const tabs = [
    { id: 'parts' as TabType, label: 'Parts Catalog', icon: Package, show: true },
    { id: 'vanstock' as TabType, label: 'Van Stock', icon: Truck, show: canViewVanStock },
    { id: 'confirmations' as TabType, label: 'Confirmations', icon: CheckSquare, show: canViewConfirmations },
  ].filter(tab => tab.show);
