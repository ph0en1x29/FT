...
CREATE TABLE IF NOT EXISTS van_stocks (
  ...
  -- technician_name fetched via join to users table

  -- Van identification
  van_code TEXT UNIQUE,  -- Unique van identifier (license plate, van number, etc.)
  notes TEXT,            -- Optional notes about this van
